import { mockEncrypter, mockHashComparer, mockLoadAccountByEmailRepositoryStub, mockUpdateAccessTokenRepository } from '@/data/test'
import { mockAuthentication } from '@/domain/test'
import { DbAuthentication } from './db-authenticator'
import {
  Encrypter,
  HashComparer,
